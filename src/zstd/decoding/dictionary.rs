...
use crate::zstd::decoding::errors::DictionaryDecodeError;
use crate::zstd::decoding::scratch::FSEScratch;
use crate::zstd::decoding::scratch::HuffmanScratch;
...
impl Dictionary {
    ...
    pub fn decode_dict(raw: &[u8]) -> Result<Dictionary, DictionaryDecodeError> {
        ...
        let of_size = new_dict.fse.offsets.build_decoder(
            raw_tables,
            crate::zstd::decoding::sequence_section_decoder::OF_MAX_LOG,
        )?;
        ...
        let ml_size = new_dict.fse.match_lengths.build_decoder(
            raw_tables,
            crate::zstd::decoding::sequence_section_decoder::ML_MAX_LOG,
        )?;
        ...
        let ll_size = new_dict.fse.literal_lengths.build_decoder(
            raw_tables,
            crate::zstd::decoding::sequence_section_decoder::LL_MAX_LOG,
        )?;
