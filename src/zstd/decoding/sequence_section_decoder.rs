...
use crate::zstd::bit_io::BitReaderReversed;
use crate::zstd::blocks::sequence_section::{
    MAX_LITERAL_LENGTH_CODE, MAX_MATCH_LENGTH_CODE, MAX_OFFSET_CODE,
};
use crate::zstd::decoding::errors::DecodeSequenceError;
use crate::zstd::fse::FSEDecoder;
use std::vec::Vec;
...
#[test]
fn test_ll_default() {
    let mut table = crate::zstd::fse::FSETable::new(MAX_LITERAL_LENGTH_CODE);
    table
